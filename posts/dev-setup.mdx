...
- **[Cron](https://cron.com/)** is a calendar that has good keyboard shortcuts (VIM based), a command palette and an awesome menu bar app. <br />
  With the menu bar app you can press <Keycap>⌘</Keycap>+<Keycap>^</Keycap>+<Keycap>K</Keycap> to open
  an agenda view of your next few days and with <Keycap>⌘</Keycap>+<Keycap>^</Keycap>+
  <Keycap>J</Keycap> **join** the upcoming Zoom meeting 🤯
...
<figure>
  ...
  <Figcaption>
    In this demo I'm pressing <Keycap>⌥</Keycap>+<Keycap>Shift</Keycap>+
    <Keycap>L</Keycap> to cycle through the windows clock wise and{" "}
    <Keycap>⌥</Keycap>+<Keycap>Shift</Keycap>+<Keycap>Space</Keycap> to change
    layouts.
  </Figcaption>
</figure>
...
I use the <Keycap>⌥</Keycap>+<Keycap>Some key</Keycap> keybinding. E.g, <Keycap>⌥</Keycap>+<Keycap>S</Keycap> for slack, <Keycap>⌥</Keycap>+<Keycap>I</Keycap> for my terminal (used to be iTerm) etc.<br />
...
- [Bitwarden](https://github.com/bitwarden/browser) is my password manager. It has useful keyboard shorcuts: <Keycap>⌘</Keycap>+<Keycap>Shift</Keycap>+<Keycap>Y</Keycap> to open the vault and <Keycap>⌘</Keycap>+<Keycap>Shift</Keycap>+<Keycap>L</Keycap> to auto-fill the username/password.

- [TickTick](https://ticktick.com) is my todos app. You can press <Keycap>⌘</Keycap>+<Keycap>^</Keycap>+<Keycap>A</Keycap> to quickly add a new todo item in a floating window.
...
The _reason I'm using it_ is that it's minimal and its settings are stored in a single `.yaml` file. I can easily back it up to my dotfiles repo.
...
<Note>
  Interestingly enough, Neovim came in #1 🥇 in the [Stackoverflow 2021
  Developer
